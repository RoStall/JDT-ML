...
plt.imshow(scores, interpolation='nearest', cmap=plt.cm.binary,
           norm=MidpointNormalize(vmin=0.2, midpoint=0.69))
plt.xlabel('gamma')
...
# plt.show()
plt.savefig('/Users/robertstallard/Dropbox/NASA_stretch/JDT-ML/graphics/gridsearch_rbf_svc_5fold_multiclass.png', dpi=350,
            bbox='tight')
